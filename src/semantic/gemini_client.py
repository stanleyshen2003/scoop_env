...
if __name__ == '__main__':
    ...
    semantic = get_semantic(instruction, object_list, action_list=action_list, action_seq=['grasp_spoon', 'move_to_green_bowl', 'stir', 'scoop', 'move_to_white_round_plate', 'put_food', 'put_spoon_back'])
    print(semantic)