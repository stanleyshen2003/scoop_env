...
class WeighingDomainInfo(object):
    ...
    def get_domain_parameters(self, type='all'):
        if type == 'all':
            ...
            target_parameters = [self.ball_radius, self.ball_mass, self.ball_friction, self.ball_layer_num, self.goal_powder_amount, self.gravity]
    ...
    def get_domain_parameter_dim(self):
        ...
        return len([self.ball_radius, self.ball_mass, self.ball_friction, self.ball_layer_num, self.goal_powder_amount, self.gravity])
